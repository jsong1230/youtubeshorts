...
### 4. 스케줄링
- **자동 스케줄러**: 하루 6개를 4시간 간격으로 자동으로 영상 생성 및 업로드
- **최적화된 시간 배분**: 기본 시작 시간에서 4시간 간격으로 6번 업로드 (예: 09:00, 13:00, 17:00, 21:00, 01:00, 05:00)
...
스케줄러는 매일 기본 시작 시간(기본값: 09:00, 한국 시간)부터 4시간 간격으로 총 6번 자동으로 영상을 생성하고 업로드합니다.
예: 09:00, 13:00, 17:00, 21:00, 01:00, 05:00
...
- **업로드 시작 시간**: `UPLOAD_SCHEDULE_TIME=09:00` (24시간 형식, 이 시간부터 4시간 간격으로 6번 업로드)
