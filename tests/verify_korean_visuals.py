...
def test_background_video_manager_keywords():
    ...
    print("✅ BackgroundVideoManager includes Korean category keywords for language='ko'")
...
def test_image_generator_korean_prompt():
    ...
    generator._http_get_with_retry = MagicMock(return_value=MagicMock(status_code=200, content=b"fake_image_content"))
