...
class TestYouTubeUploaderUpload:
    ...
    @patch('src.utils.youtube_auth.get_authenticated_service')
    def test_upload_video_success(self, mock_auth, temp_video_file, sample_video_metadata):
    ...
    @patch('src.utils.youtube_auth.get_authenticated_service')
    def test_upload_video_with_thumbnail(self, mock_auth, temp_video_file, 
                                        temp_thumbnail_file, sample_video_metadata):
    ...
    @patch('src.utils.youtube_auth.get_authenticated_service')
    def test_upload_video_api_error(self, mock_auth, temp_video_file, sample_video_metadata):
...
class TestYouTubeUploaderIntegration:
    ...
    @patch('src.utils.youtube_auth.get_authenticated_service')
    def test_upload_and_get_stats_workflow(self, mock_auth, temp_video_file, sample_video_metadata):
