...
class TestMultiPlatformUploaderInit:
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_init_with_all_platforms(
        self, mock_config, mock_youtube, mock_tiktok, mock_instagram
    ):
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_init_handles_tiktok_unavailable(
        self, mock_config, mock_youtube, mock_tiktok
    ):
...
class TestMultiPlatformUploaderUpload:
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_upload_to_all_youtube_only(
        self, mock_config, mock_youtube, temp_video_file, sample_video_metadata
    ):
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_upload_to_all_multiple_platforms(
        self,
        mock_config,
        mock_youtube,
        mock_tiktok,
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_upload_to_all_file_not_found(
        self, mock_config, mock_youtube, sample_video_metadata
    ):
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_upload_to_specific_platforms(
        self, mock_config, mock_youtube, temp_video_file, sample_video_metadata
    ):
    ...
    @patch("src.uploaders.multi_platform_uploader.YouTubeUploader")
    @patch("src.uploaders.multi_platform_uploader.settings")
    def test_upload_handles_platform_errors(
        self,
        mock_config,
        mock_youtube,
        mock_tiktok,
...
class TestMultiPlatformUploaderIntegration:
    ...
    def test_upload_with_thumbnail(
        ...
        assert (
            "thumbnail_path" in call_args.kwargs
            or temp_thumbnail_file in call_args.args
        )
