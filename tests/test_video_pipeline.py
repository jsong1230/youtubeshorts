...
class TestVideoPipeline:
    ...
    def pipeline(self, tmp_path):
        ...
        pipeline.metadata_manager.generate_description = Mock(return_value="Test Description")
    ...
    def test_check_constraints_already_uploaded(self, pipeline):
        ...
        pipeline.sync_manager.get_today_upload_info = Mock(return_value={'video_id': '123'})
    ...
    def test_get_performance_prompt(self, pipeline):
        ...
        pipeline.database.get_top_performing_videos = Mock(return_value=[
            {'topic': 'Test Topic 1', 'engagement_rate': 3.5}
        ])
        pipeline.database.get_top_topics = Mock(return_value=[
    ...
    def test_generate_content(self, pipeline, tmp_path):
        ...
        pipeline.video_generator.generate_video = Mock(return_value=(
            video_path, thumbnail_path, "Test Topic", ['Script']
        ))
    ...
    def test_run_success(self, pipeline, tmp_path):
        ...
        pipeline._generate_content = Mock(return_value={
