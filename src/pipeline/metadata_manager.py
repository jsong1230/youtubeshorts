...
class MetadataManager:
    ...
    def generate_description(
        ...
        if language == 'en':
            return self._generate_english_description(original_topic, channel_info, recent_videos)
        else:
            return self._generate_korean_description(original_topic, channel_info, recent_videos)
