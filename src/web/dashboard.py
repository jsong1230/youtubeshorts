...
def get_overview_stats():
    ...
    try:
        ...
        avg_engagement_rate = sum(v.get('engagement_rate', 0) for v in videos) / total_videos if total_videos > 0 else 0
...
def get_thumbnail_stats():
    ...
    try:
        ...
        performance = thumbnail_optimizer.get_thumbnail_performance(days=days, min_impressions=100)
...
def analyze_comments():
    ...
    try:
        ...
        if video_id:
            ...
            # 최근 영상들 댓글 분석
            result = comment_analyzer.analyze_recent_videos_comments(num_videos=num_videos)
