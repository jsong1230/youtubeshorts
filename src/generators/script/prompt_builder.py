...
class PromptBuilder:
    ...
    def _get_english_prompts(self, content_type: ContentType, target_duration: int) -> Dict[ContentType, Tuple[str, int]]:
...
- Create engaging, actionable content that viewers can apply immediately""", 16),
    ...
    def _get_korean_prompts(self, content_type: ContentType, target_duration: int) -> Dict[ContentType, Tuple[str, int]]:
