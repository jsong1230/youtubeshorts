...
class AIVideoGenerator:
    ...
    def _generate_topic(self, content_type: ContentType = None) -> tuple:
        ...
        if content_type == ContentType.HOOK:
            ...
            topics = [
                "월급 300에서 3년 만에 자산 3억 만든 사람의 비밀",
                "AI 자동화를 만들어 퇴사한 사람 이야기",
                "부업으로 월 500 만든 직장인의 실화",
                "작은 기술 하나로 인생 역전한 사례",
                "빚에서 벗어나 자산가가 된 이야기",
                "퇴직금을 3배로 만든 실제 재테크 사례",
                "부동산 실패 후 성공한 사람의 전략",
                "복리의 힘을 깨닫고 달라진 삶",
                "크립토로 10배 수익낸 사람들의 공통점",
                "꾸준함으로 부자가 된 평범한 사람 이야기",
                "하루 10분 투자로 자산을 키운 사례",
                "가난에서 벗어나기 위해 바꾼 습관",
                "돈을 못 모으던 사람이 바꾼 단 하나의 행동",
                "리스크를 줄이고 기회를 잡은 이야기",
                "패시브 인컴이 실제로 생긴 사례",
            ]
            ...
            topics = [
                "돈을 버는 사람과 못 버는 사람의 차이",
                "아무리 벌어도 모이지 않는 이유",
                "부자가 되고 싶다면 바꿔야 할 1가지",
                "성공은 운이 아니라 구조의 문제다",
                "가난을 벗어나기 위한 시작점",
                "작은 습관 하나가 만든 큰 변화",
                "돈에 대한 무서운 진실",
