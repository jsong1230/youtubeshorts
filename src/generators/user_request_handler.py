...
class UserRequestHandler:
    ...
    def _init_database(self):
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_priority ON user_requests(priority)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_requested_at ON user_requests(requested_at)')
    ...
    def add_request(
        ...
        try:
            ...
            cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (topic, source, source_id, priority, RequestStatus.PENDING.value, requested_by, now, notes, now, now))
