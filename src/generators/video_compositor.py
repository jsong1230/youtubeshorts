...
class VideoCompositor:
    ...
    def create_video_from_script(
        ...
        background_groups, downloaded_video_ids = self.background_manager.prepare_background_clips(
        ...
        self.video_editor.save_video(
            final_video, output_path, final_video.duration if final_video.audio else None
        )
