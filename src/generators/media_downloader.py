...
class MediaDownloader:
    ...
    def __init__(self, openai_client=None, http_get_with_retry=None, api_call_with_retry=None):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get('photos') and len(data['photos']) > 0:
                    ...
                    img_response = self._http_get_with_retry(image_url, headers=headers, timeout=10)
