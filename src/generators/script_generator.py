        ...
        try:
            ...
            for model in models_to_try:
                try:
                    ...
                    filtered_sentences = self.script_parser.parse_script_text(script_text, max_sentences)
                    
                    # 반복 구절 제거
                    filtered_sentences = self.script_parser.remove_repetitive_phrases(filtered_sentences)
