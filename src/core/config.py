...
class Settings(BaseSettings):
    ...
    YOUTUBE_CLIENT_SECRET: Optional[str] = Field(None, validation_alias='YOUTUBE_CLIENT_SECRET')
    YOUTUBE_REFRESH_TOKEN: Optional[str] = Field(None, validation_alias='YOUTUBE_REFRESH_TOKEN')
    ...
    DEFAULT_TAGS: Union[List[str], str] = Field(
        default_factory=lambda: ['shorts', '쇼츠', 'ai', '인공지능', '자동생성', '유용한정보', '팁', '라이프스타일', '일상', '정보', '꿀팁', '생활정보'],
    ...
    GOOGLE_CLOUD_CREDENTIALS_PATH: Optional[str] = Field(None, validation_alias='GOOGLE_CLOUD_CREDENTIALS_PATH')
    ...
    ENABLE_INSTAGRAM_UPLOAD: bool = Field(False, validation_alias='ENABLE_INSTAGRAM_UPLOAD')
    
    # TikTok API
    TIKTOK_CLIENT_KEY: Optional[str] = Field(None, validation_alias='TIKTOK_CLIENT_KEY')
    TIKTOK_CLIENT_SECRET: Optional[str] = Field(None, validation_alias='TIKTOK_CLIENT_SECRET')
    TIKTOK_ACCESS_TOKEN: Optional[str] = Field(None, validation_alias='TIKTOK_ACCESS_TOKEN')
    TIKTOK_REFRESH_TOKEN: Optional[str] = Field(None, validation_alias='TIKTOK_REFRESH_TOKEN')
    
    # Instagram Graph API
    INSTAGRAM_APP_ID: Optional[str] = Field(None, validation_alias='INSTAGRAM_APP_ID')
    INSTAGRAM_APP_SECRET: Optional[str] = Field(None, validation_alias='INSTAGRAM_APP_SECRET')
    INSTAGRAM_ACCESS_TOKEN: Optional[str] = Field(None, validation_alias='INSTAGRAM_ACCESS_TOKEN')
    INSTAGRAM_ACCOUNT_ID: Optional[str] = Field(None, validation_alias='INSTAGRAM_ACCOUNT_ID')
    
    # Parallel Processing
    MAX_PARALLEL_WORKERS: int = Field(3, validation_alias='MAX_PARALLEL_WORKERS')
    ENABLE_PARALLEL_GENERATION: bool = Field(True, validation_alias='ENABLE_PARALLEL_GENERATION')
