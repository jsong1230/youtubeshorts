...
class ABTestDatabase:
    ...
    def _init_database(self):
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_content_type ON ab_tests(content_type)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_engagement_rate ON ab_tests(engagement_rate)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_upload_date ON ab_tests(upload_date)')
    ...
    def add_test(
        ...
        try:
            ...
            cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            ''', (video_id, topic, content_type, style, style_config_json, now, now, now))
        ...
        try:
            ...
            if row:
                ...
                cursor.execute('''
                    ...
                    WHERE video_id = ?
                ''', (views, likes, comments, watch_time, engagement_rate, 
