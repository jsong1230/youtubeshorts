...
def test_cpm_analysis():
    ...
    keywords = ["finance", "investing", "funny cat", "insurance", "daily vlog", "mortgage", "tutorial"]
...
def test_topic_database_cpm():
    ...
    for topic_dict in high_cpm_topics:
        print(f"    - {topic_dict['topic'][:50]:50s} (CPM: {topic_dict.get('cpm_score', 'N/A')})")
...
def test_cpm_keyword_prioritization():
    ...
    test_keywords = [
        "finance", "cats", "insurance", "vlog", "investing", 
        "tutorial", "mortgage", "gaming", "productivity"
    ]
